...
import { TeamCarousel } from "./TeamCarousel";
 ...
 export const TeamSection = () => {
   return (
     <section className="relative content-center items-center bg-neutral-100 box-border caret-transparent gap-x-8 flex flex-col shrink-0 h-min justify-center gap-y-8 w-full z-[1] overflow-hidden px-[18px] py-20 md:pt-[100px] md:pb-[60px] md:px-10">
