...
export const ServicesSection = () => {
  return (
    <section id="services" className="relative content-center items-center bg-neutral-100 box-border caret-transparent gap-x-10 flex flex-col shrink-0 min-h-screen justify-center gap-y-10 w-full z-[2] overflow-hidden px-6 py-20 scroll-mt-2.5 md:px-12 lg:px-20 md:py-[100px]">
