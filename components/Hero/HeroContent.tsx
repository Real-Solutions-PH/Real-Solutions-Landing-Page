...
export const HeroContent = () => {
  return (
    <div className="relative content-center items-center box-border caret-transparent gap-x-[30px] flex flex-col shrink-0 h-min justify-center max-w-[1350px] gap-y-[30px] w-full z-[4]">
